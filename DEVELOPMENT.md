...
```bash
git remote add encore encore://orthopaedic-office-website-fba2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/orthopaedic-office-website-fba2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/orthopaedic-office-website-fba2/settings/integrations/github)
