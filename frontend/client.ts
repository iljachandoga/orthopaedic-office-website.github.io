 ...
 */
export class Client {
    public readonly practice: practice.ServiceClient
    ...
    constructor(target: BaseURL, options?: ClientOptions) {
        ...
        this.practice = new practice.ServiceClient(base)
    }
 ...
 */
import { requestAppointment as api_practice_appointments_requestAppointment } from "~backend/practice/appointments";
import { submitContact as api_practice_contact_submitContact } from "~backend/practice/contact";
...
export namespace practice {
    ...
    export class ServiceClient {
         ...
         */
        public async requestAppointment(params: RequestType<typeof api_practice_appointments_requestAppointment>): Promise<ResponseType<typeof api_practice_appointments_requestAppointment>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/appointments/request`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_practice_appointments_requestAppointment>
        }

        /**
         * Odošle dotaz z kontaktného formulára.
         */
        public async submitContact(params: RequestType<typeof api_practice_contact_submitContact>): Promise<ResponseType<typeof api_practice_contact_submitContact>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/contact`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_practice_contact_submitContact>
        }
    }
}
